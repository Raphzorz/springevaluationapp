...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AppComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_div_1_Template_button_click_18_listener() {
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(ecommerceService) {
      ...
      _createClass(AppComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {} //The database is queried for a matching entry
        ...
        value: function login(userName) {
          ...
          this.ecommerceService.getUserByName(userName).subscribe(function (users) {
            _this.users = users;

            _this.users.forEach(function (users) {
              if (users.userName) {
                _this.logged = true; //Assigning the logged user to be the user selected/logged in

                _this.ecommerceService.loggedUser = users;
              }
            }, function (error) {
        ...
        value: function userNotFound() {
          var element = document.getElementById("login-input-bar");
    ...
    AppComponent.ɵfac = function AppComponent_Factory(t) {
      return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ecommerce_services_EcommerceService__WEBPACK_IMPORTED_MODULE_1__["EcommerceService"]));
    };
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 2,
      consts: [["class", "container align-content-center justify-content-center", 4, "ngIf"], [3, "hidden"], ["ecommerceC", ""], [1, "container", "align-content-center", "justify-content-center"], [1, "my-5"], [1, "card-body"], [1, "sidenav"], [1, "login-main-text"], [1, "main"], [1, "col-md-6", "col-sm-12"], [1, "login-form"], [1, "form-group"], ["for", "login-input-bar"], ["type", "text", "id", "login-input-bar", "placeholder", "User Name", 1, "form-control"], ["userInput", ""], ["type", "submit", 1, "btn", "btn-login", 3, "click"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
        ...
        return [{
          type: _ecommerce_services_EcommerceService__WEBPACK_IMPORTED_MODULE_1__["EcommerceService"]
        }];
      }, {
        ecommerceC: [{
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _ecommerce_baskets_baskets_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./ecommerce/baskets/baskets.component */
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _ecommerce_ecommerce_component__WEBPACK_IMPORTED_MODULE_5__["EcommerceComponent"], _ecommerce_products_products_component__WEBPACK_IMPORTED_MODULE_6__["ProductsComponent"], _ecommerce_shopping_cart_shopping_cart_component__WEBPACK_IMPORTED_MODULE_7__["ShoppingCartComponent"], _ecommerce_baskets_baskets_component__WEBPACK_IMPORTED_MODULE_8__["BasketsComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppEcommerceBasketsBasketsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BasketsComponent", function () {
    ...
    var BasketsComponent = /*#__PURE__*/function () {
      function BasketsComponent(ecommerceService) {
        _classCallCheck(this, BasketsComponent);

        this.ecommerceService = ecommerceService;
        this.baskets = this.ecommerceService.ProductBaskets;
      }

      _createClass(BasketsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this2 = this;

          this.paid = false;
          this.sub = this.ecommerceService.BasketsChanged.subscribe(function () {
            _this2.baskets = _this2.ecommerceService.ProductBaskets;
          });
        }
      }]);
    ...
    BasketsComponent.ɵfac = function BasketsComponent_Factory(t) {
      return new (t || BasketsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_EcommerceService__WEBPACK_IMPORTED_MODULE_1__["EcommerceService"]));
    };

    BasketsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: BasketsComponent,
      selectors: [["app-baskets"]],
      decls: 0,
      vars: 0,
      template: function BasketsComponent_Template(rf, ctx) {},
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BasketsComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppEcommerceEcommerceComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _baskets_baskets_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./baskets/baskets.component */
    "./src/app/ecommerce/baskets/baskets.component.ts");
    ...
    var EcommerceComponent = /*#__PURE__*/function () {
      ...
      _createClass(EcommerceComponent, [{
        ...
        key: "finishBasket",
        value: function finishBasket(basketFinished) {
    ...
    EcommerceComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 19,
      vars: 6,
      consts: [[1, "navbar", "navbar-expand-lg", "navbar-dark", "bg-dark"], [1, "container"], ["href", "#", 1, "navbar-brand"], ["type", "button", "data-toggle", "collapse", "data-target", "#navbarResponsive", "aria-controls", "navbarResponsive", "aria-expanded", "false", "aria-label", "Toggle navigation", 1, "navbar-toggler", 3, "click"], [1, "navbar-toggler-icon"], ["id", "navbarResponsive", 3, "ngClass"], [1, "navbar-nav", "ml-auto"], [1, "nav-item", "active"], [3, "hidden", "onBasketFinished"], ["shoppingCartC", ""], [1, "row"], [1, "col-md-12"], [3, "hidden"], ["productsC", ""], [1, "col-md-3"], [1, "col-md-6", "offset-3"], ["basketsC", ""]],
      template: function EcommerceComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onBasketFinished", function EcommerceComponent_Template_app_shopping_cart_onBasketFinished_9_listener($event) {
            return ctx.finishBasket($event);
          });
  ...
  /***/
  function srcAppEcommerceModelsProductBasketModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProductBasket", function () {
      return ProductBasket;
    });

    var ProductBasket = function ProductBasket(product, user) {
      _classCallCheck(this, ProductBasket);
  ...
  /***/
  function srcAppEcommerceModelsProductBasketsModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProductBaskets", function () {
      return ProductBaskets;
    });

    var ProductBaskets = function ProductBaskets() {
      _classCallCheck(this, ProductBaskets);
  ...
  function srcAppEcommerceProductsProductsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _models_product_basket_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../models/product-basket.model */
    "./src/app/ecommerce/models/product-basket.model.ts");
    /* harmony import */
    ...
    function ProductsComponent_tr_39_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ProductsComponent_tr_39_Template_input_ngModelChange_7_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);

          var basket_r3 = ctx.$implicit;

          var ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r4.addToCartPreemptiveList(basket_r3);
        });
      ...
      _createClass(ProductsComponent, [{
        ...
        value: function keyListener() {
          ...
          document.getElementById('search-bar').addEventListener('keypress', function (e) {
            return _this3.validateTextField(e);
          });
        } // Regex

      }, {
        key: "validateTextField",
        value: function validateTextField(event) {
        ...
        key: "addCheckedItemsToCart",
        value: function addCheckedItemsToCart() {
        ...
        key: "checkCartForDuplicates",
        value: function checkCartForDuplicates() {
          var listOfCartIds = [];
          var j;
        ...
        key: "addToCart",
        value: function addToCart(basket) {
        ...
        value: function getProductIndex(product) {
          return this.ecommerceService.ProductBaskets.productBaskets.findIndex(function (value) {
        ...
        value: function loadProducts() {
          ...
          this.ecommerceService.getAllProducts().subscribe(function (products) {
            ...
            _this4.products.forEach(function (product) {
              _this4.productBaskets.push(new _models_product_basket_model__WEBPACK_IMPORTED_MODULE_1__["ProductBasket"](product, _this4.user));
            });
          }, function (error) {
            return console.log(error);
          });
        ...
        key: "addToCartPreemptiveList",
        value: function addToCartPreemptiveList(product) {
          var element = document.getElementById("tr-" + product.product.id);
        ...
        key: "loadFilteredProducts",
        value: function loadFilteredProducts(keyword) {
          var _this5 = this;

          //  First remove the checked products so as not to be able to add unseen products
          this.toAddToCartList = [];
          this.ecommerceService.getProductByKeyword(keyword, this.selectedCategory).subscribe(function (products) {
            _this5.products = products; // Delete the list before adding the item

            _this5.productBaskets = [];

            _this5.products.forEach(function (product) {
              _this5.productBaskets.push(new _models_product_basket_model__WEBPACK_IMPORTED_MODULE_1__["ProductBasket"](product, _this5.user));
            });
          }, function (error) {
            return console.log(error);
          });
        ...
        key: "loadBaskets",
        value: function loadBaskets() {
          var _this6 = this;

          this.sub = this.ecommerceService.BasketsChanged.subscribe(function () {
            _this6.shoppingCartBaskets = _this6.ecommerceService.ProductBaskets;
          });
        }
      }, {
        key: "reset",
    ...
    ProductsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 40,
      vars: 1,
      consts: [[1, "container"], [1, "display-2", "font-weight-bold"], ["id", "search-form"], [1, "form-group", "form-inline"], ["for", "search-bar"], ["id", "search-bar", "maxlength", "30", "pattern", "^[a-zA-Z\\\\s]*$/*", "placeholder", "Search by product name", "type", "text", 1, "shadow-sm", "form-control", 3, "keypress"], ["titleInput", ""], ["for", "product-types"], ["id", "product-types", "name", "productType", "form", "search-form", 1, "ml-2", "form-control", "form-control-md", "shadow-sm", "rounded", 3, "change"], ["chosenCategory", ""], ["hidden", ""], ["value", "Music"], ["value", "Games"], ["value", "Books"], [1, "ml-2", "btn", 3, "click"], ["aria-hidden", "true", 1, "ml-2", "fa", "fa-search"], [1, "btn", "add-button", 3, "click"], [1, "table", "text-center"], [1, "thead-dark"], [3, "id", 4, "ngFor", "ngForOf"], [3, "id"], [1, "custom-control", "custom-checkbox", "custom-checkbox-green"], ["type", "checkbox", "name", "cb", 1, "custom-control-input-green", "custom-control-input", 3, "id", "ngModel", "ngModelChange"], [1, "custom-control-label", 3, "for"]],
      template: function ProductsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keypress", function ProductsComponent_Template_input_keypress_7_listener() {
            return ctx.keyListener();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ProductsComponent_Template_select_change_10_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductsComponent_Template_button_click_22_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6);

            var _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](8);

            return ctx.loadFilteredProducts(_r0.value);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductsComponent_Template_button_click_26_listener() {
            return ctx.addCheckedItemsToCart();
          });
  ...
  function srcAppEcommerceServicesEcommerceServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _models_product_baskets_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../models/product-baskets.model */
    "./src/app/ecommerce/models/product-baskets.model.ts");
    /* harmony import */
    ...
    var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! @angular/common/http */
    "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js"); //This class takes care of the communications between the backend & frontend
    ...
    var EcommerceService = /*#__PURE__*/function () {
      function EcommerceService(http) {
        ...
        this.keywordSearchUrl = "/api/products/filter-products?keyword="; //Product Baskets is the list of items in the cart
      ...
      _createClass(EcommerceService, [{
        ...
        key: "getProductByKeyword",
        value: function getProductByKeyword(keyword, category) {
          return this.http.get(this.keywordSearchUrl + keyword + "&category=" + category);
        }
      }, {
        key: "checkForPreviousPurchases",
        value: function checkForPreviousPurchases(basket) {
          return this.http.post(this.basketsUrl + "/check", basket);
        }
      }, {
        key: "saveBasket",
        value: function saveBasket(basket) {
          return this.http.post(this.basketsUrl, basket);
        }
      }, {
        key: "SelectedProductBasket",
  ...
  function srcAppEcommerceShoppingCartShoppingCartComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _models_product_basket_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../models/product-basket.model */
    "./src/app/ecommerce/models/product-basket.model.ts");
    /* harmony import */
    ...
    function ShoppingCartComponent_h5_18_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ShoppingCartComponent_h5_19_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h5", 18);
    ...
    function ShoppingCartComponent_ul_20_li_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ShoppingCartComponent_ul_20_li_1_Template_button_click_2_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7);

          var basket_r5 = ctx.$implicit;

          var ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r6.removeFromCart(basket_r5);
        });
    ...
    function ShoppingCartComponent_ul_20_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ShoppingCartComponent_div_25_p_5_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ShoppingCartComponent_div_25_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var ShoppingCartComponent = /*#__PURE__*/function () {
      ...
      _createClass(ShoppingCartComponent, [{
        ...
        key: "removeFromCart",
        value: function removeFromCart(productBasket) {
          var index = this.getProductIndex(productBasket.product);
        ...
        value: function loadCart() {
          ...
          this.sub = this.ecommerceService.ProductBasketChanged.subscribe(function () {
            var productBasket = _this7.ecommerceService.SelectedProductBasket;

            if (productBasket) {
              if (_this7.baskets.productBaskets) _this7.baskets.productBaskets.push(new _models_product_basket_model__WEBPACK_IMPORTED_MODULE_2__["ProductBasket"](productBasket.product, _this7.ecommerceService.loggedUser)); //NB: This.baskets.productBaskets contains the User & The Product
            } //this.baskets or ProductBaskets are the list of items in the cart.


            _this7.ecommerceService.ProductBaskets = _this7.baskets;
            _this7.baskets = _this7.ecommerceService.ProductBaskets;
          });
        } //Checks the user's purchase history and does not allow them to purchase the same product twice

      }, {
        key: "checkBeforeSaveToBasket",
        value: function checkBeforeSaveToBasket() {
          var _this8 = this;

          this.safeToSave = false;
          this.listOfAlreadyPurchasedProducts = [];
          this.ecommerceService.checkForPreviousPurchases(this.baskets).subscribe(function (products) {
            _this8.products = products;

            _this8.products.forEach(function (product) {
              _this8.listOfAlreadyPurchasedProducts.push(product);
            }); // If there are already purchased products then the basket shall be cancelled


            if (_this8.listOfAlreadyPurchasedProducts.length < 1) {
              _this8.safeToSave = true;
            }
    ...
    ShoppingCartComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function ShoppingCartComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ShoppingCartComponent_Template_button_click_22_listener() {
            return ctx.checkBeforeSaveToBasket();
          });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\rapha\IdeaProjects\boot\ecommerce\src\main\frontend\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
